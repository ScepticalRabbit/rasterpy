...
# ==============================================================================
"""Verify exact match between GridInt2D and Riley Case 3 renders."""
...
def verify_preset(preset_name: str) -> tuple[float, int]:
    ...
    plot_comparison(
        ...
        img_r_flt,
        diff_flt,
        title_prefix=f"Case 3 ({preset_name})",
...
def main() -> None:
    """Run verification across all Case 3 presets."""
    print("=" * 70)
    print("Verifying Case 3: GridInt2D vs Riley Polynomial Renders")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("Case 3 Verification Summary")
    print("=" * 70)
