...
# ==============================================================================
"""Verify exact match between GridInt2D and Riley Case 2 renders."""
...
def verify_preset(preset_name: str) -> tuple[float, int]:
    ...
    plot_comparison(
        ...
        img_r_flt,
        diff_flt,
        title_prefix=f"Case 2 ({preset_name})",
...
def main() -> None:
    """Run verification across all Case 2 presets."""
    print("=" * 70)
    print("Verifying Case 2: GridInt2D vs Riley Extended Brown-Conrady Renders")
    print("=" * 70)
