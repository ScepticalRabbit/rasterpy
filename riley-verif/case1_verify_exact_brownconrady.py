...
# ==============================================================================
"""Verify exact match between GridInt2D and Riley Case 1 renders."""
...
def verify_preset(preset_name: str) -> tuple[float, int]:
    ...
    plot_comparison(
        ...
        img_r_flt,
        diff_flt,
        title_prefix=f"Case 1 ({preset_name})",
...
def main() -> None:
    """Run verification across all Case 1 presets."""
    print("=" * 70)
    print("Verifying Case 1: GridInt2D vs Riley Brown-Conrady Renders")
    print("=" * 70)
