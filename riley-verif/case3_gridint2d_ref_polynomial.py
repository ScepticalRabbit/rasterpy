...
# ==============================================================================
"""Render standalone polynomial distorted references using GridInt2D."""
...
from rasterpy.pxint2d.distortion import PolynomialMap


def render_preset(preset: PolyPreset) -> tuple[np.ndarray, np.ndarray]:
    """Render a single polynomial preset using GridInt2D."""
    ...
    distortion = PolynomialMap(
        order=preset.order,
        coeffs_u=preset.coeffs_u,
        coeffs_v=preset.coeffs_v,
    )
...
def main() -> None:
    """Execute all Case 3 GridInt2D renders."""
    print("=" * 70)
    print("Running Case 3: GridInt2D Standalone Polynomial Renders")
    print("=" * 70)
    ...
    print("\nCase 3 GridInt2D renders completed successfully.")
