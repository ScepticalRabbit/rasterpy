...
# ==============================================================================
"""Render Extended Brown-Conrady distorted grid references using GridInt2D."""
...
from rasterpy.pxint2d.distortion import BrownConradyExt


def render_preset(preset: BCExtPreset) -> tuple[np.ndarray, np.ndarray]:
    """Render a single Extended Brown-Conrady preset using GridInt2D."""
...
def main() -> None:
    """Execute all Case 2 GridInt2D renders."""
    print("=" * 70)
    print("Running Case 2: GridInt2D Extended Brown-Conrady Renders")
    print("=" * 70)

    OUT_GRIDINT2D_DIR.mkdir(parents=True, exist_ok=True)

    for preset in BCEXT_PRESETS:
    ...
    print("\nCase 2 GridInt2D renders completed successfully.")
