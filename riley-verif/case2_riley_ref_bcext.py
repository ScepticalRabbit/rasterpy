...
# ==============================================================================
"""Render Extended Brown-Conrady distorted references using Riley rasteriser."""
...
def render_preset(preset: BCExtPreset) -> tuple[np.ndarray, np.ndarray]:
    """Render a single Extended Brown-Conrady preset using Riley."""
    ...
    camera = riley.Camera(
        ...
        distortion_model=2,  # brown_conrady_ext
...
def main() -> None:
    """Execute all Case 2 Riley renders."""
    print("=" * 70)
    print("Running Case 2: Riley Extended Brown-Conrady Renders")
    print("=" * 70)
    ...
    print("\nCase 2 Riley renders completed successfully.")
